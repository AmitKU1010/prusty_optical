  ...
  <div class="pageprint" style="border: 1px solid">
   <table width="100%">
      ...
      <div style="color:red; font-size:25px">S. PRUSTY OPTICALS <br>
        ...
        <br>
        Plot No.-551, Jagamara Chhak, New Road, BBSR<br>
        GSTIN - 21APBPP7295J2ZL
        </div>
    </center></td>
          ...
          <h3 style="text-transform: capitalize; ">
           <table width="100%">
            <tr>
              ...
              <td width="50%">&#8377; <?php echo number_format((float)($rowdata['total_price_one']), 2, '.', ''); ?></td>
            </tr>
           	<tr>
           		<td width="50%">Charges Of Glass</td>
           		<td width="50%">&#8377; <?php echo number_format((float)($rowdata['charges_of_glass']), 2, '.', ''); ?></td>
            </tr>
            ...
            ?>
           		...
           		<tr>
           		<td width="50%">CGST(<?php echo $rowdata['tax']/2; ?>%)</td>
           		<td width="50%">&#8377; <?php echo number_format((float)($half_the_tax), 2, '.', ''); ?></td>

           	</tr>
           		<tr>
           		<td width="50%">SGST(<?php echo $rowdata['tax']/2; ?> %)</td>
           		<td width="50%">&#8377; <?php echo number_format((float)($half_the_tax), 2, '.', ''); ?></td>
           	</tr>
           		<tr>
           		<td width="50%">Grand Total</td>
           		<td width="50%">&#8377; <?php echo number_format((float)($grand_total), 2, '.', ''); ?></td>
           	</tr>
           		<tr>
           		<td width="50%">Advance </td>
           		<td width="50%">&#8377; <?php echo number_format((float)($rowdata['advance']), 2, '.', ''); ?></td>
           	</tr>
           		<tr>
           		<td width="50%">Balance</td>
           		<td width="50%">&#8377; <?php echo number_format((float)($rowdata['balance']), 2, '.', ''); ?></td>
