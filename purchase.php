...
<div class="clearfix"></div>
  <div class="content-wrapper">
   ...
   <div class="form-body">
      <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>PURCHASE PRODUCT</h6>
      ...
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              ...
              <form method="post" action="purchase_submit.php">
               <!-- row start -->
             <div class="row">
              
                              <div class="col-md-4" >
                                  <div class="form-group ">
                                    <label class="control-label mb-10">Select Supplier</label>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group ">
                                    ...
                                    <input type="date"  maxlength="50" name="supplier_date" id="supplier_date" class="form-control" >
                                    <span class="help-block"> </span>
                                  </div>
                                </div> 
                                </div>  
