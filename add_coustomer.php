   ...
   <div class="form-body">
     ...
     <hr class="light-grey-hr"/>
      ...
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              <form method="post" action="coustomer_submit.php">
               <!-- row start -->
               <div class="row">
              
                              <div class="col-md-4" >
                                  <div class="form-group ">
                                    <label class="control-label mb-10">Coustomer Name</label>
                                    <input type="text"  maxlength="50"  name="coustomer_name" id="coustomer_name" class="form-control"  placeholder="supplier Name">
                                ...
                                <div class="col-md-4">
                                  <div class="form-group ">
                                    ...
                                    <input type="date"  maxlength="50" name="coustomer_date" id="supplier_date" class="form-control"  placeholder="Model Price">
                                    <span class="help-block"> </span>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group ">
                                    ...
                                    <input type="text"  maxlength="50" name="coustomer_email" id="supplier_email" class="form-control"  placeholder="Model Price">
                                    <span class="help-block"> </span>
                                  </div>
                                </div>
                                </div>
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                    ...
                    $i = 1;
                      ...
                      ?>
                      <td><?php echo $i;?></td>
                      <td><?php echo $row["coustomer_name"];?></td>
                      <td><?php echo $row["mobile_number"];?></td>
                      <td><?php echo $row["coustomer_date"];?></td>
                      <td><?php echo $row["coustomer_address"];?></td>
                      <td><?php echo $row["coustomer_email"];?></td>
