...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add Corporate Payment(coustomer)</h6>
                              <hr class="light-grey-hr"/>
                            </div>
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              <form action="ajax_submit_corporate_payment_coustomer_slip.php" method="post">
               <!-- row start -->
                         <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>View Corporate Payment(coustomer)</div>
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                    <tr>
                       <?php
                    $sql = "SELECT * FROM corporate_coustomer_payment_slip";
                    ...
                    $i = 1;
                     ...
                     <td>#<?php echo $i;?></td>
                      ...
                      <td class="text-nowrap">
                       ...
                       <a href="corporate_customer_archieve.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                       </i>
                     </a>
                      
                    <a href="bill_corporate_coustomer_archieve.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                    </i>
                     </a>

                     <a href="bill_archieve_corporate_coustomer_withoutgst.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                    </i>
                     </a>
                 ...
                 $('#journey_from').val(obj[0].place_from);
                  ...
                  $('#fuel_rate').val(obj[0].fuel_rate);
                    ...
                    if (!$("#charging_type").val().length == 0)
                    {
                      ...
                      ({
                        type:"post",
                        url:"ajax_carcharges_corporate_customer_get.php",
                        dataType:"html", // Data type, HTML, json etc.
