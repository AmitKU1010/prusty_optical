...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add Hotel Payment</h6>
      ...
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              ...
              <form action="ajax_submit_hotel_payment_slip.php" method="post">
               <!-- row start -->
                         <div class="row">
                                ...
                                <div class="col-md-4">
                                  <div class="form-group ">
                                    ...
                                    <input type="text"  maxlength="30" name="hotel_name"  id="hotel_name" class="form-control">
                                    <span class="help-block"> </span>
                                  </div>
                                </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>View Hotel Payment</div>
            <div class="card-header">
              <form method="post">
                               <div class="pull-right">
                                 <input type="date" name="start_client">
                                 <input type="date" name="end_client">
                            ...
                            if(isset($_POST['submit_client']))
                              {
                                  ...
                                  echo $three_client= date_format($date_client,"Y-m-d");
                                  $end_client=$_POST['end_client'];
                                  $date2_client=date_create($end_client);
                                 echo  $four_client=date_format($date2_client,"Y-m-d");
                                 echo $person_name=$_POST['serach'];

                                  $sql = "SELECT * FROM `hotel_payment_slip`  WHERE 
                                    hotel_name LIKE '%"."$person_name"."%' AND `duty_date` BETWEEN '$three_client' AND '$four_client'";
                              }
                  else
                   {
                    $sql = "SELECT * FROM hotel_payment_slip";
                    }
                    ...
                    $i = 1;
                     ...
                     <td>#<?php echo $i;?></td>
                      ...
                      <td class="text-nowrap">
                       ...
                       <a href="hotel_archieve.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                       </i>
                     </a>
                      
                    <a href="hotel_bill_archieve.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                    </i>
                     </a>

                     <a href="bill_archieve_withoutgst_hotel.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                    </i>
                     </a>
  ...
  $(document).on('blur', '#duty_slip_no', function()
            {
              ...
              ({
                type:"post",
                url:"ajax_dutyslip_hotel_get.php",
                ...
                success:function(response)
                {
                 ...
                 $('#journey_from').val(obj[0].place_from);
                  ...
                  $('#hotel_name').val(obj[0].hotel_name);
                    ...
                    if (!$("#charging_type").val().length == 0)
                    {
                      ...
                      ({
                        type:"post",
                        url:"ajax_carcharges_hotel_get.php",
                        dataType:"html", // Data type, HTML, json etc.
